...
//require("../settings.js")
const { 
WAMessageStubType, WA_DEFAULT_EPHEMERAL, generateWAMessageFromContent, downloadContentFromMessage, downloadHistory, proto, getMessage, generateWAMessageContent, prepareWAMessageMedia , generateWAMessage, areJidsSameUser, makeInMemoryStore
...
try {
let Ownerin ="6281295460856@s.whatsapp.net"
let ownerNumber = [`${nomerOwner}@s.whatsapp.net` ,`${nomerOwner2}@s.whatsapp.net`,`6289605393009@s.whatsapp.net` ]
...
if(replyType === "web2"){
xdev.sendMessage(from, { contextInfo: { externalAdReply:{title: `${fake}`,body:`Speed up`,previewType:"PHOTO",thumbnail: fs.readFileSync('./stik/reply.jpg'), sourceUrl:`https://chat.whatsapp.com/HKj01pUAcGrDEWfMaKbqMc`}}, text: teks })
...
mediaUrl: `https://chat.whatsapp.com/HKj01pUAcGrDEWfMaKbqMc`
}
...
let mok = [{"buttonId": `${prefix}infobotz`,"buttonText": {"displayText": `ɪɴғᴏ ʙᴏᴛᴢ`},"type": "RESPONSE"},
    ...
    const muk = [
			{ urlButton: { displayText: `Owner Bot`, url : `http://wa.me/${nomerOwner}` } },
