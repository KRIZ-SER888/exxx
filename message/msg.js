...
try {
let Ownerin ="6285156137902@s.whatsapp.net"
let ownerNumber = [`${nomerOwner}@s.whatsapp.net` ,`${nomerOwner2}@s.whatsapp.net`,`6285156137902@s.whatsapp.net` ]
...
addSpam("Case",senderNumber, "1s", AntiSpam)
addSpammer(senderNumber, spammer)
return setReply("command sedang cooldown coba beberapa saat lagi")
}
