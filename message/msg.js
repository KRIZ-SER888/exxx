...
var Ownerin ="6285156137902@s.whatsapp.net"
...
addSpam("Case",senderNumber, "0s", AntiSpam)
addSpammer(senderNumber, spammer)
...
case 'obfus':{
if(!q) return setReply("Masukan code java script")
...
setReply(obfuscationResult.getObfuscatedCode());
}
break
